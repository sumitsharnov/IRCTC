...
public class E2ETest extends BasePage {
	...
	public static By errorMessageLocation = By.xpath(cons.erorMessageXpath); 
	...
	public void i_click_on_login_button() throws Throwable {
		...
		while(driver.findElement(errorMessageLocation).getText() != null)
		{
			Thread.sleep(3000);
			//i_do_the_needful_required_for_successful_login();
			try {
